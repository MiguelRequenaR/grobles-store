      ...
      className="max-w-7xl mx-auto">
        ...
        className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-10 min-h-screen">
          ...
          className="w-full lg:w-1/3 lg:sticky lg:top-40 self-start">
            <h2
            className="text-white text-2xl font-bold mb-3 md:mb-4 text-center lg:text-left uppercase">Preguntas frecuentes</h2>
            <p
            className="text-white text-base text-center lg:text-left uppercase">
            ...
            {questions.map((question) => {
              ...
              return (
                ...
                className="bg-primary border border-gray-400 rounded-xl md:rounded-2xl overflow-hidden transition-all duration-700 ease-out">
                  ...
                  >
                    <h3
                    className="text-white text-lg font-bold text-left pr-3 md:pr-4 uppercase">
                      {question.question}
                    </h3>
                    <ChevronDown
