    ...
    <main className="max-w-7xl mx-auto py-10 px-4 md:py-20" data-aos="fade-up">
      ...
      >
        <div className="w-full md:w-2/3 space-y-4 md:space-y-4 text-center md:text-left">
          <span className="bg-black uppercase text-white px-3 py-2 rounded-full inline-block mx-auto md:mx-0 text-sm md:text-base">
          ...
          <p className="text-gray-400 text-sm md:text-base uppercase">
        ...
        <div className="w-full md:w-1/3 mt-6 md:mt-0 flex">
          <a href="https://www.groblestudio.com/contact" className="w-full bg-white text-primary border border-transparent px-4 py-2 rounded-full cursor-pointer hover:bg-transparent hover:text-white hover:border-white transition-all duration-500 flex items-center justify-center gap-2 uppercase text-sm md:text-base">
